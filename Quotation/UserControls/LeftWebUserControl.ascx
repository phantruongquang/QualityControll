<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LeftWebUserControl.ascx.cs" Inherits="Quotation_UserControls_LeftWebUserControl" %>
        ...
        <td align="center" style="background-color: darkblue" valign="middle">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <br />
                    <asp:LinkButton ID="lnlApprove" runat="server" Font-Bold="True" Font-Size="18pt"
                        ForeColor="#C0FFFF" Width="120px" OnClick="lnlApprove_Click">Approve</asp:LinkButton><br />
                    <br />
