...
public partial class Enquiry_UserControls_HeaderUserControl : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            btnEnquiry.BackColor = Color.DarkBlue;
            btnEnquiry.ForeColor = Color.AliceBlue;
            btnEnquiry.Font.Bold = true;
        }
    }
