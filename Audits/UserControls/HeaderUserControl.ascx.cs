...
public partial class Audits_UserControls_HeaderUserControl : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            btnAudits.BackColor = Color.DarkBlue;
            btnAudits.ForeColor = Color.AliceBlue;
            btnAudits.Font.Bold = true;
        }
    }
