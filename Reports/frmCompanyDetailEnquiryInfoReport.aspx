<%@ Page Language="C#" MasterPageFile="~/Reports/ReportsMasterPage.master" AutoEventWireup="true" CodeFile="frmCompanyDetailEnquiryInfoReport.aspx.cs" Inherits="Reports_frmCompanyDetailEnquiryInfoReport" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="left" border="1" cellpadding="0" cellspacing="0" style="width: 659px;
        ...
        <tr>
            ...
            <td align="left">
                <strong>Scope Of Registration:</strong></td>
            <td align="left">
                <asp:TextBox ID="txtRegisScope" runat="server" ReadOnly="True" Width="199px"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="left" style="font-weight: bold; font-size: 12pt">
