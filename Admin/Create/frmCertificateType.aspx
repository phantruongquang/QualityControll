<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmCertificateType.aspx.cs" Inherits="Admin_Create_frmCertificateType" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" style="font-weight: bold; font-size: 14pt; color: #99ffff; background-color:blue">
                Certificate Type Information</td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label ID="lblCertId" runat="server" Text='<%#Eval("cert_type_id") %>' Visible="false">
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Certificate Type">
                            <ItemTemplate>
                                <asp:Label ID="lbl1" runat="server" Text='<%#Eval("cert_type") %>'>
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CertificateType Description">
                            <ItemTemplate>
                                <asp:Label ID="lbl2" runat="server" Text='<%#Eval("cert_type_desc") %>'>
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Modify">
                            <ItemTemplate>
                                <asp:Button ID="btnModify" runat="server" CommandArgument='<%#Eval("cert_type_id") %>'
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 564px">
                            <tr>
                                <td colspan="2" style="font-weight: bold; font-size: 14pt; color: #99ffff; height: 22px;
                                    ...
                                    Update Certificate Type Information</td>
                            </tr>
                            <tr>
                                <td>
                                    Certificate Type:</td>
                                <td style="width: 100px">
                                    <asp:TextBox ID="txtCertType" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
                                    Description:</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 555px">
                            <tr>
                                <td align="left" colspan="2" style="font-weight: bold; font-size: 14pt; color: #99ffff;
                                    background-color:Blue">
                                    New Certificate Type Information</td>
                            </tr>
                            <tr>
                                <td>
                                    Certificate Type:</td>
                                <td>
                <asp:TextBox ID="txtCertificateType" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
                                    Description:</td>
