<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmFeedbackType.aspx.cs" Inherits="Admin_Create_frmFeedbackType" Title="Untitled Page" %>
            ...
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label ID="lblId" runat="server" Text='<%#Eval("feedback_type_id") %>' Visible="false">
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="FeedBack Type">
                            <ItemTemplate>
                                <asp:Label ID="lbl1" runat="server" Text='<%#Eval("feedbacktype") %>'>
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="FeedBack Description">
                            <ItemTemplate>
                                <asp:Label ID="lbl2" runat="server" Text='<%#Eval("feedbackdesc") %>'>
                              </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Modify">
                            <ItemTemplate>
                                <asp:Button ID="btnModify" runat="server" CommandArgument='<%#Eval("feedback_type_id") %>'
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 564px">
                            ...
                            <tr>
                                ...
                                <td style="width: 100px">
                                    <asp:TextBox ID="txtFeedType" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
                                    Description:</td>
                    ...
                    <div style="text-align: left">
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 555px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtFeedBackType" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
                                    Description:</td>
