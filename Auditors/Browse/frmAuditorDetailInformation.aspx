<%@ Page Language="C#" MasterPageFile="~/Auditors/AuditorMasterPage.master" AutoEventWireup="true" CodeFile="frmAuditorDetailInformation.aspx.cs" Inherits="Auditors_Browse_frmAuditorDetailInformation" Title="Untitled Page" %>
    ...
    <table align="left" border="1" cellpadding="0" cellspacing="0" style="width: 548px;
        ...
        <tr>
            <td align="left" style="width: 123px">
                Auditor Type:</td>
            <td align="left">
                <asp:TextBox ID="txtAuditorType" runat="server" Width="148px" ReadOnly="True"></asp:TextBox></td>
            <td align="left">
                Auditor Name:</td>
            <td align="left">
                <asp:TextBox ID="txtAuditorName" runat="server" ReadOnly="True"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="left" style="width: 123px">
                Qualification:</td>
            <td align="left">
                <asp:TextBox ID="txtQualification" runat="server" Width="148px" ReadOnly="True"></asp:TextBox></td>
            <td align="left">
                Experiance:</td>
            <td align="left">
                <asp:TextBox ID="txtExp" runat="server" Width="148px" ReadOnly="True"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="left" style="width: 123px">
            ...
            <td align="left">
                <asp:TextBox ID="txtIRCANo" runat="server" ReadOnly="True"></asp:TextBox></td>
            <td align="left">
                LACourseDate:</td>
            <td align="left">
        ...
        <tr>
            <td align="left" style="width: 123px">
                Lacert No:</td>
            <td align="left">
                <asp:TextBox ID="txtLacertNo" runat="server" ReadOnly="True"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" style="width: 123px">
                <span style="font-size: 12pt; font-family: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman';
                    ...
                    Address1:</span></td>
            <td align="left">
                <asp:TextBox ID="txtAddr1" runat="server" ReadOnly="True"></asp:TextBox></td>
            <td align="left">
                Address2:</td>
            <td align="left">
                <asp:TextBox ID="txtAddr2" runat="server" ReadOnly="True"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="left" style="width: 123px">
                City:</td>
        ...
        <tr>
            <td align="right" colspan="4">
                <asp:Button ID="btnPrint" runat="server" OnClick="btnSubmit_Click" Text="Print" Width="65px" />
            </td>
        </tr>
        <tr>
            <td align="center" colspan="4">
