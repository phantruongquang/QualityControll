<%@ Page Language="C#" MasterPageFile="~/Auditors/AuditorMasterPage.master" AutoEventWireup="true" CodeFile="frmCreateAuditors.aspx.cs" Inherits="Auditors_Create_frmCreateAuditors" Title="Untitled Page" %>

<%@ Register Assembly="GMDatePicker" Namespace="GrayMatterSoft" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="left" border="1" cellpadding="0" cellspacing="0" style="width: 443px; color: darkblue; background-color: #ccccff;">
        <tr>
        ...
        <tr>
            <td align="left" style="width: 123px">
                Auditor Type:</td>
            <td align="left">
                <asp:DropDownList ID="ddlAuditorType" runat="server" Width="125px">
                </asp:DropDownList></td>
            <td align="left">
                Auditor Name:</td>
            <td align="left">
        ...
        <tr>
            ...
            <td align="left">
                SIC Code:</td>
            <td align="left">
                <asp:TextBox ID="txtSICCode" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
